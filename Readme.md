...
Предполагается взять последнее дз (по книгам), допилить регистрацию, холдера, его места регулярного посещения и кнопку взять книгу, а именно:
Проектная работа представляет из себя web-приложение хранящее информацию о книгах у пользователей и позволяющее забронировать интересующие пользователей книги и договориться о передаче книги новому держателю. После бронирования держателем книги становится пользователь-приобретатель. Плиск книг осуществляется с учетом мест регулярного посещения книгодержателей (пока только город, возможно и расстояние от пользователя, бронирующего книгу до мест регярного посещения книгодержателей).
