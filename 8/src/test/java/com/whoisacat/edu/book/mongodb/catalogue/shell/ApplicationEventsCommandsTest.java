...
import com.whoisacat.edu.book.mongodb.catalogue.service.AuthorServiceSimple;
import com.whoisacat.edu.book.mongodb.catalogue.service.BookServiceSimple;
...
class ApplicationEventsCommandsTest{
    ...
    public static final Author AUTHOR = new Author(("1"),TRUE_LA_LA);
    ...
    void findAuthorsList(){
        shell.evaluate(() -> LOGIN);
        when(authorService.findAuthorsByTitle("name")).thenReturn(TRUE_LA_LA);
    ...
    void addBook(){
        ...
        assertThat(shell.evaluate(() -> "ab " + TRUE_LA_LA + " " + TRUE_LA_LA + " " + TRUE_LA_LA))
                .isEqualTo(ApplicationEventsCommands.BOOK_ADDED_SUCCESSFULLY.concat("BOOK"));
    }
