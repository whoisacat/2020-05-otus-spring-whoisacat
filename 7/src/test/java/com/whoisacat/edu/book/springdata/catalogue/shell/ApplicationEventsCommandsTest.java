...
import com.whoisacat.edu.book.springdata.catalogue.service.AuthorServiceSimple;
import com.whoisacat.edu.book.springdata.catalogue.service.BookServiceSimple;
...
import static com.whoisacat.edu.book.springdata.catalogue.shell.ApplicationEventsCommands.BOOK_ADDED_SUCCESSFULLY;
...
class ApplicationEventsCommandsTest{
    ...
    public static final Author AUTHOR = new Author((1L),TRUE_LA_LA);
